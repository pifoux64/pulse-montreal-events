            ...
            <div className="bg-white/5 rounded-xl p-4 mb-6 text-left">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-slate-300 space-y-2">
                  <p>1. Ouvrez votre boîte de réception</p>
                  <p>2. Cliquez sur le lien de connexion</p>
                  <p>3. Vous serez automatiquement connecté</p>
                </div>
              </div>
            </div>
            <p className="text-sm text-slate-400">
              Le lien expire dans 24 heures. Si vous ne recevez pas l'email, vérifiez votre dossier spam.
            </p>
          </div>
        </div>
      </div>
