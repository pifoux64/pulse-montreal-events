...
-- CreateIndex
CREATE UNIQUE INDEX "unique_user_role" ON "user_role_assignments"("user_id", "role");

-- CreateIndex
CREATE INDEX "idx_user_role_user" ON "user_role_assignments"("user_id");

-- CreateIndex
CREATE INDEX "idx_user_role_role" ON "user_role_assignments"("role");

-- CreateIndex
CREATE UNIQUE INDEX "unique_venue_claim" ON "venue_claims"("venue_id", "user_id");

-- CreateIndex
CREATE INDEX "idx_venue_claim_venue" ON "venue_claims"("venue_id");

-- CreateIndex
CREATE INDEX "idx_venue_claim_user" ON "venue_claims"("user_id");

-- CreateIndex
CREATE INDEX "idx_venue_claim_status" ON "venue_claims"("status");
